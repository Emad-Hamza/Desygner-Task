 ...
 */
final class Version20220224165546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT NOT NULL, name VARCHAR(255) NOT NULL, provider VARCHAR(255) NOT NULL, external_url TEXT DEFAULT NULL, PRIMARY KEY(id))');
